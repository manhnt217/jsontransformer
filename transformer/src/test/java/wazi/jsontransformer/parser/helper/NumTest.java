...
public class NumTest {
	...
	public void testNumber() {
		Num n1 = new Num(11);
		Num n2 = new Num(4);
		assertEquals(15, n1.exe(Operator.Op.PLUS, n2).get());
	}
	...
	public void testNumber2() {
		Num n1 = new Num(11);
		Num n2 = new Num(4);
		assertEquals(11.0/4, n1.exe(Operator.Op.DIVIDE, n2).get());
	}
	...
	public void testNumber3() {
		Num n1 = new Num(-11);
		Num n2 = new Num(4);
		assertEquals(-2, n1.exe(Operator.Op.DIV, n2).get());
	}
	...
	public void testNumber4() {
		Num n1 = new Num(8.5);
		Num n2 = new Num(1.6);
		assertEquals(8.5 % 1.6, n1.exe(Operator.Op.MOD, n2).get());
	}
	...
	public void testNumberExeException() {
		Num n1 = new Num(-3);
		Num n2 = new Num(4);
		assertEquals(0, n1.exe(Operator.Op.AND, n2).get());
