 ...
 */
public class LogicalExpressionParser implements TokenParser<LogicalExpression> {

	private final MultiChoiceParser<BaseExpression> expressionParser = new MultiChoiceParser<>();
